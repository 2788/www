...
$(document).ready ->
 ...
 # 导航栏菜单
  if isMobile
    ...
    $('#spaces-dropdown, #solution-dropdown, #user-dropdown, #language-dropdown, #more-dropdown').on 'touchstart', ->
    ...
    $('#spaces-dropdown, #solution-dropdown, #user-dropdown, #language-dropdown, #more-dropdown').hover ->
      $(this).addClass('open')
    , ->
