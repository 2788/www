...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { business: @recommendation.business, company: @recommendation.company, email: @recommendation.email, im: @recommendation.im, intention: @recommendation.intention, ip: @recommendation.ip, name: @recommendation.name, phone: @recommendation.phone, referer: @recommendation.referer, uid: @recommendation.uid, website: @recommendation.website } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { business: @recommendation.business, company: @recommendation.company, email: @recommendation.email, im: @recommendation.im, intention: @recommendation.intention, ip: @recommendation.ip, name: @recommendation.name, phone: @recommendation.phone, referer: @recommendation.referer, uid: @recommendation.uid, website: @recommendation.website } }
