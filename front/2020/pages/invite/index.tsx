...
function PageContent() {
  ...
  const modal = (
    <OverlayModal title="活动规则" className={style.modal}>
      <ol>
        <li>活动开始时间：2018 年 9 月 1 日。</li>
        <li>标准用户指完成实名认证的个人用户或企业用户。</li>
        <li>首充指受邀人第一次充值，充值奖励发放额度以受邀人首次充值为准。首充时间应发生在受邀人注册的 1 个月之内，逾期充值不计在奖励范围内。</li>
        <li>每个邀请人最多可累计获得 1000 元购物卡。</li>
        <li>邀请标准用户（个人/企业）所获得的免费 CDN 下载流量，每个邀请人（以邀请人注册邮箱为准）最高可累计 40GB/月，邀请成功后，免费流量次月生效，永久有效。</li>
        <li>抵用券有效期为 6 个月，有效期的起始时间以抵用券到账时间为准。</li>
        <li>抵用券的发放：产品抵用券在受邀人实名认证后，自动发放至邀请人账户，每个账户（以注册邮箱为准）仅发放一次，不可累计。</li>
        <li>邀请成功后，邀请人可在“财务中心 &gt; 抵用券”查看 200 元产品抵用券，500 元充值抵用券在邀请人单次充值达到 5000 元后自动发放至“财务中心 &gt; 抵用券”。</li>
        <li>购物卡奖励，每自然月结算一次，由市场部统一发放给符合购物卡奖励标准的邀请人（首充购物卡奖励首充后次月发放）。</li>
        <li>
          邀请者与被邀请者实际是同一用户不可获得奖励（同一用户指包含但不仅限于根据不同七牛云账号在注册、登录、使用中的关联信息，七牛云判断其实际为同一用户。关联信息举例：同一证件、同一手机号、同一支付账号、同一设备、同一地址等）。
        </li>
        <li>如用户存在作弊、欺诈或通过其他非正常手段获取利益的行为，七牛云有权收回相关权益。</li>
        <li>此次活动奖励不可与其他优惠同享。</li>
        <li>已签约代理商不参与此次活动。</li>
        <li>如受邀人注销账户，邀请人获得的奖励将被扣除。</li>
        <li>本次活动解释权归七牛云所有，如有任何问题，欢迎邮件联系 <a href="mailto:marketing@qiniu.com">marketing@qiniu.com</a>。</li>
      </ol>
    </OverlayModal>
  )
  ...
  const rewardHeader = (
    <>
      丰厚奖励<br />
      <a className={style.rewardLink} onClick={() => addModal(modal)}>活动规则 &gt;&gt;</a>
    </>
  )
