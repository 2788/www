...
const funcs = [
  { icon: <Icon1 />, title: '语音识别', desc: '语音识别包括实时录音文件识别、一句话识别、实时语音识别三类服务。录音文件支持支持对提交的录音文件进行转写，输出文字。一句话语音识别通常应用于小于 60s 的指令，短消息类的语音场景，针对请求的语音返回文本，可应用于机器人问答、智能家电助手等场景。实时语音识别有“边说边出文本”的效果，应用于对实时性有要求的场景，如语音机器人、智能会议、智能硬件、直播字幕等。' },
