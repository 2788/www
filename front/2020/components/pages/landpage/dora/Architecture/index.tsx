    ...
    <Section title="产品架构" name="arch">
      <svg width="660" height="310" viewBox="0 0 660 310">
        <defs>
          ...
          <polygon id="智能视频服务-j" points="40 26.667 40 51.651 25.778 51.651 25.778 47.182 35.53 47.18 35.531 26.667"></polygon>
          ...
          <polygon id="智能视频服务-l" points="26 20.579 45.95 33.73 52 18"></polygon>
        ...
        <g fill="none" fillRule="evenodd">
          <use stroke="#00AAE7" strokeDasharray="4 8" strokeWidth="2" mask="url(#智能视频服务-b)" xlinkHref="#智能视频服务-a"></use>
          <Link className={style.link} href={urlMap[Product.Dora]}>
          ...
          <g transform="translate(12 16)">
            ...
            <g transform="translate(18)">
              ...
              <use fill="#319EEA" xlinkHref="#智能视频服务C"></use>
              <use fill="#000" filter="url(#智能视频服务-d)" xlinkHref="#智能视频服务C"></use>
            </g>
          </g>
          ...
          <g transform="translate(528 16)">
            ...
            <g transform="translate(18)">
              ...
              <polygon fill="#34A1EC" points="42 23 84 23 84 55 42 29.2" transform="matrix(-1 0 0 1 126 0)"></polygon>
              <polygon fill="#98D5FF" points="0 23 42 47.949 84 23 42 0"></polygon>
              <use fill="#2793DF" xlinkHref="#智能视频服务-e"></use>
              <use fill="#000" filter="url(#智能视频服务-f)" xlinkHref="#智能视频服务-e"></use>
            </g>
          </g>
          ...
          <g transform="translate(356 16)">
            ...
            <g transform="translate(18)">
              ...
              <polygon fill="#98D5FF" points="0 23 42 47.949 84 23 42 0"></polygon>
              <g fillRule="nonzero">
                <use fill="#2C98E4" xlinkHref="#智能视频服务-g"></use>
                <use fill="#000" filter="url(#智能视频服务-h)" xlinkHref="#智能视频服务-g"></use>
              </g>
            </g>
          </g>
          <Link className={style.link} href={urlMap[Product.Censor]}>
          ...
          <g transform="translate(184 12)">
            ...
            <g transform="translate(28)">
              ...
              <g transform="rotate(45 32.889 39.159)">
                <use fill="#2C99E4" xlinkHref="#智能视频服务-j"></use>
                <use fill="#000" filter="url(#智能视频服务-k)" xlinkHref="#智能视频服务-j"></use>
              </g>
            </g>
          </g>
          ...
          <g transform="translate(270 201)">
            ...
            <g transform="translate(18)">
              ...
              <polygon fill="#34A1EC" points="42 23 84 23 84 55 42 29.2" transform="matrix(-1 0 0 1 126 0)"></polygon>
              <polygon fill="#98D5FF" points="0 23 42 47.949 84 23 42 0"></polygon>
              <use fill="#319EEA" xlinkHref="#智能视频服务-l"></use>
              <use fill="#000" filter="url(#智能视频服务-m)" xlinkHref="#智能视频服务-l"></use>
            </g>
          </g>
