  ...
  return (
    <Tabs defaultValue="1">
      <TabPane value="1" tab="互联网">
        ...
        >
          石墨文档是中国第一款支持云端实时协作的企业办公服务软件，可以实现多人同时在同一文档及表格上进行编辑和实时讨论，同步响应速度达到毫秒级。在赋予产品高协作性功能的基础上，石墨文档还是一款具有中国式美感的科技产品，2015年获得极客公园评选的最佳互联网创新产品50强。在SaaS类协作云文档国内市场占有规模排名第一。
        </Case>
        <Case
          title="淡蓝"
          url="/TODO"
      ...
      <TabPane value="3" tab="传媒">
        ...
        >
          中国网是国务院新闻办公室领导，中国外文出版发行事业局管理的国家重点新闻网站。自 2000 年成立以来，陆续实现了用中、英、法、西、德、日、俄、阿、韩、世界语10个语种11个文版，24小时对外发布信息，访问用户覆盖全球200多个国家和地区，成为中国进行国际传播、信息交流的重要窗口。
        </Case>
      </TabPane>
