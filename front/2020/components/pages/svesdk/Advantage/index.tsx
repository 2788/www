...
import compatIcon from './images/compatibility.png'
...
export default function Advantage() {
  return (
    <Section title="核心优势" name="advantage">
      <Row>
        <MyCard
          icon={<Icon src={nodeIcon} />}
          title="性能卓群，功能强大"
          desc={['100+ 功能点，覆盖手机短视频制作的大部分场景', '3+ 年时间打磨，在拍摄、转码等方面性能优异', '包体轻盈、扩展性好']}
        />
        <MyCard
          icon={<Icon src={compatIcon} />}
          title="技术融合，各取所长"
          desc={['基于短视频业务特点，对七牛短视频 SDK 和行业内领先的美颜特效 SDK 的接口层进行了技术优化，兼容性强', '迭代方便，可快速升级']}
        />
        <MyCard
