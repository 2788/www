...
export default function MutipleMediaProcessPlat() {
  const { productType, isVideo, isMachine } = useContext(Context)

  if (isMachine) return null
  return (
    <>
      {/* zIndex 保证移动的过程中不会其他覆盖 */}
      <Positioned top={isVideo ? 200 : 75} left={isVideo ? 491 : 320} zIndex={1}>
        <svg width="144" height="141">
          ...
          <g fill="none">
            <g transform="translate(0 109)" style={{ display: productType === 'all' ? 'block' : 'none' }}>
