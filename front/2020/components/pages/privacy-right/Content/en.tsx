  ...
  return (
    <div className={style.content}>
      ...
      <p className={style.bold}>
        ...
        whether you are an individual or a business user. By using our service,
        it means that you have confidence on the way we handle your information.
      ...
      <p className={style.bold}>
        ...
        read, fully understood and accepted the provisions of this Policy
        (minors shall read this Policy with the company of their legal
        guardians), and this Policy shall have legal effect between you and
      ...
      <p>
        ...
        &quot;our&quot; refers to Shanghai Qiniu Information Technology Co.,
        Ltd. unless otherwise specifically indicated.
      </p>
      <p>
        1.2 &quot;Affiliate&quot; refers to its subordinate companies or other
        affiliates in the scope of consolidated financial statements of Qiniu
        Cloud.
      </p>
      <p>
        1.3 &quot;User&quot; or &quot;You&quot; refers to the individual or
        enterprise that uses Qiniu Cloud&#39;s products and/or services.
      </p>
      <p>
        1.4 &quot;Third party&quot; means a company or individual (unaffiliated)
        to which we are related, other than by reason of common ownership or
        control, or any other unrelated individual.
      </p>
      <p>
        1.5 &quot;Personal information&quot; refers to various types of
        information recorded by electronic or other means that can, either alone
        or in combination with other information, identify a specific natural
        person or reflect the activities of a specific natural person. The
        personal information referred to in this Policy is of the type listed in
        the section of How We Collectand Use Personal Information About You. For
        the avoidance of doubt, Personal information includes, but is not
        limited to, personally sensitive information.
      </p>
      <p>
        1.6 &quot;Personal sensitive information&quot; refers to the personal
        information that once disclosed or illegally used, may easily lead to
        damage to personal dignity or personal or property safety, and may
        easily lead to the damage to personal reputation and physical and mental
        health or discriminatory treatment. Personal sensitive information
        involved in this Policy may include: your property information
        (including virtual property information such as bank account and
        prepayment information); personal identity information (including ID
        card); online identification information (including account name,
        account nickname, email address and passwords related to the foregoing);
        other information (including address book, personal telephone number,
      ...
      <p>
        ...
        cannot be identified or associated with specific individuals. It
        includes anonymized (irrecoverable) information and all non-personal
        information of corporate users that has already been publicly disclosed
        by the relevant competent authorities (such as corporate contact
        address, contact information, years of operation, enterprise scale,
        industries engaged in, main businesses, main products, website domain
        names, etc.).
      </p>
      <p>
        1.8 &quot;De-identification&quot; refers to the process of making
        personal information unable to identify or associated with you without
        the use of additional information through technical processing of the
        personal information.
      </p>
      <p>
        1.9 &quot;Delete&quot; refers to the action of removing personal
        information from the system concerned with realizing daily business
        functions, so that the personal information remains in a state in which
        the information cannot be retrieved or accessed.
      </p>
      <p>
        1.10 &quot;Anonymization&quot; refers to the process in which personal
        information is processed by technology so that you cannot identify or
        associate with it and the processed information cannot be recovered.
      </p>
      <h3>2. How We Collect and Use Personal Information about You</h3>
      <p>
        We collect and use your personal information only for the following
        purposes as described in this Policy:
      </p>
      <p>
        2.1 In order to better serve you, Qiniu Cloud will comply with the
        national laws and regulations in effect and with your consent and
        collect your personal information, including:
      </p>
      <p>2.1.1 Information Provided by You</p>
      ...
      <p>
        ...
        contact methods designated by you to us to receive reminders, service
        messages, account messages, announcement messages and business notices
        (hereinafter referred to as the &quot;registered user service&quot;).
      </p>
      <p>
        ...
        process and your normal use of the Qiniu Cloud registered user service.
        If you choose to provide such information, we will protect it as
        relevant personal information. We also remind you that even if you do
        not provide us with any personal information, you can fully browse all
        the public information on our official website, but you will not be able
        to further access the Qiniu Cloud registered user service.
      </p>
      <p>(2) Real - name authentication</p>
      <p>
        To provide our basic and core technical services (including object
        storage, cloud host, cloud database, CDN, content auditing, etc., please
        refer to the real-time service content displayed at our website for
        details), you are required to complete real-name authentication before
        purchasing and using our services. We provide you various forms of
        real-name authentication as follows:
      </p>
      <p>
        ...
        ). When you choose to use bank transfer verification method, in addition
        ...
        only be used for the verification of your real-name authentication by
        Qiniu Cloud.
      </p>
      <p>
        In addition, once you complete the individual real-name authentication,
        you can also choose to continue with enterprise authentication. For
        ...
        authentication method, in addition to the above enterprise information,
      ...
      <p>
        ...
        withdrawal records, payment records, or invoice information to any
        unrelated third parties.
      </p>
      <p>(4) Additional information</p>
      <p>
        When you participate in Qiniu Cloud&#39;s specific service promotions,
        the specific identity authentication information must be collected for
        your participation in the relevant promotions. Of course, before we
        collect and use specific identification information for certain
      ...
      <p>
        (1) Device information: including the names of the device, device
        models, device settings, identifiers, regional and language settings,
        usage habits, operating system versions, settings of the device used for
        access services, and device abnormality information;
      </p>
      <p>
        (2) Log information: When you use the services provided by our website
        or related clients, we will automatically collect the details of your
        use of our services and save them as relevant web logs.Include your
        search inquiry contents, IP address, type of browser, telecom operator,
        language used, date and time of visit and webpage record of your visit;
      </p>
      <p>
        (3) Location information: including the GPS signal of the equipment or
        related information of the nearby WiFi access point, the ID of the area
        at which the equipment is located, and the ID of the network service
        provider;
      </p>
      <p>
        (4) Additional Information: Information that must be collected when you
        use a specific service in order to enable that specific service.We will
        record and analyze the user &#39; s inquiry records, trouble reporting
        records and troubleshooting process for the user &#39; s fault resulting
      ...
      <p>
        For the purpose of providing services to you, we will obtain relevant
        information about you through legal ways from relevant third-party
        sources such as affiliates and business partners. When you use the
        services of third parties, the reservation information you provide them
        may be passed on to us. You authorize us indirectly to obtain
        information about your booking information from the third parties so
        that we may process your orders. We will, according to the agreement
        with the third party, require the third party to explain the source of
        the personal information and confirm the legality of the source of the
        personal information. We will also confirm that the scope of the
        consents the third party has obtained regarding the processing of the
        personal information includes consent to our use of such personal
        information and confirm that such personal information is used in
        compliance with relevant laws and regulations.
      </p>
      <p>
        2.2 To better serve you, Qiniu Cloud will comply with the currently
        effective relevant laws and regulations and with your consent and use
        your personal information for the following purposes:
      </p>
      <p>
        2.2.1 Provide you with interactive functions and issue business
        notifications
      </p>
      <p>
        When you communicate, give feedback, share and other interactions with
        ...
        feedback interactions; you may make comments and interact with us on our
      ...
      <p>
        We will send a notice to you upon any update of the user agreement or
        the privacy policy to protect your rights and interests. In addition, we
        will inform you of the interactive response results between youand other
        users through your contact information, will inform you of feedback on
        the real-name authentication result of your account, complaint and
        report notices of right holders or users and solution of your feedback
        problems.
      </p>
      <p>2.2.2 Improve our products or services</p>
      <p>
        In order to improve our products, services and develop better services
        for you, we will use your personal information. You should be aware,
        however, that we will generally only use anonymized comprehensive and
        statistical information for this purpose, and will not personally
        identify you. We will use such information for data analysis and
        research, as well as for auditing.
      </p>
      <p>
        We will use such information to comprehensively determine the necessity
        of a particular product, solution or function of Qiniu Cloud and may
        invite users to participate in various kinds of feedback and interaction
        so as to launch new products and services (for example, communicating
        ...
        Policy that we will no longer collect your information for the above
        scenarios. This will not affect your normal use of the basic core
        technical services of Qiniu Cloud.
      </p>
      <p>2.2.3 Conducting Marketing and Promotional Activities</p>
      <p>
        The personal information collected by us will be used to promote and
      ...
      <p>
        The personal information we collect will be used to ensure the security
        and reliability of our products and services, and to prevent cyber
        fraud, cyber attacks and intrusions, etc., so as to more accurately
      ...
      <p>
        2.3 We will seek your consent when we wish to use the information for
        purposes otherthan those set out in this Policy.We will seek your
      ...
      <p>3.1 Cookie</p>
      <p>
        To make sure that Qiniu Cloud works properly, provide you with an easier
        ...
        preferences. Cookies can also help us to collect traffic information,
        analyze the effectiveness of page design and advertising, and
        continuously optimize the user-friendliness of our website and adjust
        our website according to your needs.
      </p>
      <p>
        We enable Cookies for the same reason that most Web sites and Internet
        service providers enable Cookies: to improve the user experience. We
        will not use Cookies for any purposes other than those stated in this
        Policy. You can manage or delete Cookies according to your preferences.
      ...
      <p>
        ...
        Cookies or only third-party Cookies. By default, most Internet browsers
        accept Cookies, but this can be changed. The following links provide
        instructions on how to control cookies in all major browsers:
      </p>
      <p>
        <a
          target="_blank"
      ...
      <p>
        ...
        contains a link to our click URL. If you click on that link, we track
        that click, helping us to understand your preferences for products or
        services and to improve customer service. Web beacons are usually
        transparent images embedded in a Web site or email. With pixel tags in
        an email, we can tell if an email has been opened, helping us to
        determine the number of emails sent to users or whether to send them. If
        you do not want your activity to be tracked in this way, you can
      ...
      <p>
        ...
        the providers of technical services) that we entrust
        (&quot;delegatee&quot;). For the delegatees entrusted by us to process
        your personal information, we will select the delegatees who are able to
        provide adequate guarantee of expertise, reliability and resources, and
        sign strict entrusted processing agreements and confidentiality
        agreements with them, specifying data processing matters, treatment
        period, treatment nature, treatment purpose and responsibilities of the
        two parties, and shall supervise the processing of personal information.
        We will request the delegatees to process your personal information only
        in accordance with our requirements, this Policy and any other relevant
        confidentiality and security measures, and will request the delegatees
        to return the personal information to us or delete it upon the
      ...
      <p className={cls(style.bold, style.underline)}>
        ...
        explicit consent of you (and your guardian), we solicit the
        authorization and consent from you to share personal information with
      ...
      <p>
        4.2.2 Sharing with Authorized Partners: Solely for the purposes stated
        in this Policy, certain of our services will be provided by authorized
        partners (including, without limitation, third party software
        development kits (SDK), vendors, service providers, etc.). We may share
        certain of your personal information with our partners to provide better
        customer service and user experience. We shall only share your personal
      ...
      <p className={cls(style.bold, style.underline)}>
        ...
        the cooperation and partners (if any). We will perform strict security
        inspection on the application programming interface (API) and software
        development kit (SDK) that the authorized partners use to obtain
      ...
      <p>
        ...
        name or mobile phone number, through which you may be contacted or
        identified) with our advertising and analysis partners.
      </p>
      <p>
        (2) Sharing with suppliers, service providers, and other partners.We
        send information to service providers, smart device suppliers, systems
        service providers and other partners(e.g., hardware vendors, telecom operators,
        cloud service providers) that support our business.For example, we
        provide technical infrastructure services, analyze the way our services
        are used, provide customer services, conduct compliance investigations,
        pay facilities, or conduct academic studies and investigations.We enter
        into stringent data protection agreements with the people who share our
        information. We require them to deal with the personal information in
      ...
      <p>
        ...
        or to protect the personal and property safety of Qiniu Cloud and its
        affiliated companies &#39; users or the public from infringement upon
        the personal and property safety of Qiniu Cloud and its affiliated
        companies &#39; users or the public, we may disclose the personal
        information about you in accordance with laws and regulations or rules
        of the relevant agreements on our platform, including relevant
        violations and the measures that Qiniu Cloud Platform has taken against
        you. For example, if you seriously violate our platform rules, laws and
        regulations and / or public order and good morals by using your account
        or uploading illegal videos, illegal videos and any other content to
        your users, resulting in material social impact and causing losses to
      ...
      <p>
        4.4.1 To disclose the personal information you designate in the manner
        of disclosure expressly agreed to by you based on your needs.
      </p>
      <p>
        <span>4.4.2 </span>
        <span className={cls(style.bold, style.underline)}>
        ...
        connection with the request.We are firmly convinced that there is as
        much transparency as the law permits with respect to the information we
        are asked to provide.All requests are carefully reviewed by us to ensure
        that they have a legitimate basis and will be limited to those data that
      ...
      <p>
        4.5.2 The confidential information relates to public security, public
        health and other major public interests;
      </p>
      <p>
        4.5.3 The evidence relating to criminal investigation, prosecution,
        trial and judgment execution;
      </p>
      <p>
        4.5.4 To protect your or other individuals &#39; life, property and
        other material legal rights and interests, but it is hard to obtain my
        consent;
      </p>
      <p>
        4.5.5 Personal information that you disclose to the public or provide to
        the counterparty;
      </p>
      <p>
        4.5.6 Collecting personal information from legally and publicly
        disclosed information, such as channels of news report and government
        information disclosure, etc.;
      </p>
      <p>
        4.5.7 Evaluation information or other information required by laws and
        regulations to be disclosed. For example, in order to build a
        trustworthy transaction environment for cloud market, your credit
        evaluation information(star rating, customer evaluation) needs to be
        publicly shared. If you are a service provider, you shall publicly share
        the relevant information of enterprises or natural persons in accordance
        with applicable lawsand regulations as well as the requirements of
        market rules;
      </p>
      ...
      <p>
        ...
        <span className={cls(style.bold, style.underline)}>
          ...
          protect your personal information and only provide it to others where
          necessary. If you find that your personal information has been
      ...
      <p>
        ...
        access, disclosure, use, alteration, destruction or loss. We will take
        all reasonable and practical measures to safeguard your personal
        information. In particular, we have taken the following measures:
      </p>
      <p>
        5.2.1 We de - identify the personal information we collect about you to
      ...
      <p>
        5.2.3 We only allow the employees of Qiniu Cloud who need to know the
        personal information for us, and personnel of the service company that
        is authorized to process such information on our behalf to have access
        to the personal information; furthermore, they will be required to abide
        by strict contractual confidentiality obligations and shall conduct
        safety training in due time; if they fail to perform these obligations,
        they may be investigated for legal liabilities or their relationship
        with Qiniu Cloud may be terminated.
      </p>
      <p>
        For us, the security of your information is very important. Therefore,
        we will constantly strive to protect the security of your personal
        information, and implement full storage and transmission security
        encryption and other safeguards, so as to prevent your information from
        being accessed, used or disclosed without authorization. At the same
        time, the specific content of certain encrypted data, no one but the
        user has the right to access. When we transmit and store your sensitive
        personal information, we will apply security measures such as
        encryption; when we store personal biometric information, we will use
      ...
      <p>
        ...
        inform you of the basic information and possible effect of the security
        incident, measures we have taken or will take, suggestions on your own
        prevention and reduction of the risk and remedial measures for you. We
        will notify you of the relevant information of the incident by email,
        letter, telephone call, push notice and other means. If it is difficult
        to notify each subject of personal information, we will take a
        reasonable and effective manner to release the announcement. In the
        meantime, we will also proactively report the handling of personal
      ...
      <p>
        ...
        personal information collected and generated during its operation within
        ...
        <span className={cls(style.bold, style.underline)}>
          ...
          the provisions of the relevant regulatory authorities. We shall inform
          you of the name of the offshore recipient, contact information,
          processing method, purpose of the personal information, type of
          personal information involved, and methods and procedures for you to
          exercise the subject rights of personal information against the
          offshore recipient and obtain your consent. In the meantime, we will
      ...
      <p>
        We will respond to your request for the rights set out below within the
        time frames expressly specified in this Policy. If we are unable to
        respond in a timely manner, we will also specify within such time frame
        the time frame for our response, and the reason for any failure to
        respond within the short time frame.
      </p>
      <p>
        In principle,
        <span> </span>
        <span className={cls(style.bold, style.underline)}>
          ...
          excessive technical means (for example, require the development of new
      ...
      <p>
        (1) It relates to our performance of obligations under laws and
        regulations;
      </p>
      <p>
        (2) Those directly related to national security or national defense
        security;
      </p>
      <p>
        (3) Directly related to public security, public health and major public
        interests;
      </p>
      <p>
        (4) Where the evidence is directly related to criminal investigation,
        prosecution, trial and judgment execution;
      </p>
      <p>
        (5) Where there is sufficient evidence indicating that the subject of
        personal information has subjective malice or abuses its power;
      </p>
      <p>
        (6) A position to maintain personal information or other material legal
        rights and interests such as personal statement and property for which
        it is difficult to obtain your consent
      </p>
      <p>
        (7) Where response to the request of the Personal Information Subject
        will result in material damage to the legitimate rights and interests of
        the Personal Information Subject or of other individuals or
        organizations;
      </p>
      ...
      <p>
        <span className={cls(style.bold, style.underline)}>
          ...
          us to make a correction or log in the account to make the correction
      ...
      <p>
        6.3.2 If we collect or use your personal information, but without your
        consent;
      </p>
      <p>
        6.3.3 If our processing of personal information breaches our agreement
        with you;
      </p>
      <p>
        6.3.4 If you are no longer using our products or services, or you have
      ...
      <p>
        ...
        additional collection and use of your personal information, and device
        access that you then consider unnecessary, at any time through your
        online customer service or by email, and we will respond promptly to the
        request. Upon withdrawal of your consent, we will no longer process the
        personal information on the request. However, your decision to withdraw
      ...
      <p>
        ...
        handled by contacting our online customer service. Where technically
        feasible and in reasonable cost, we may also directly transfer a copy of
      ...
      <p>
        ...
        systems, algorithms, etc. If these decisions significantly affect your
        legal rights, you are entitled to ask us for an explanation, and we will
      ...
      <p>
        ...
        <span className={style.bold}>
          ...
          reply, especially if you think that our processing of personal
          information has damaged your legitimate rights and interests, and we
      ...
      <p>
        ...
        cessation of operation by delivery or by announcement at least thirty
        days in advance, and delete or anonymize your personal information after
        the termination of service or operation.
      </p>
      <h3>7. How Do We Process Minors Personal Information</h3>
      <p>
        7.1 Our products and services are mainly targeted at adults but we
        attach great importance to the protection of the personal information of
        minors.If you are a minor we require that you and your parent or
        guardian read this Policy carefully and use our services or provide
        information to us only with your parent &#39; s or guardian &#39; s
        consent.
      </p>
      <p>
        7.2 With respect to the personal information of minors we collect with a
        parent or guardian &#39; s consent to the use of our products or
        services, we will use, share, transfer or disclose that information only
        as permitted by law or with the express consent of a parent or guardian,
        or necessary for the protection of the minor.
      </p>
      <p>
        7.3 If we find that we have collected a minor &#39; s personal
        information without verifiable prior consent of a parent or guardian, we
        attempt as soon as practicable to delete or anonymize the minor &#39; s
        information we hold.
      </p>
      <p>
      ...
      <p>
        ...
        Policy on users &#39; personal information, store, use and disclose
        children &#39; s personal information collected under the principles of
        legitimacy and necessity, informed consent, explicit purpose, security
        assurance and lawful use in strict accordance with the Provisions on the
        Online Protection of Children &#39; s Personal Information and other
        laws and regulations, and shall not exceed the necessary period for
        achieving the purpose of collection and use.Upon expiration, we will
        delete or anonymize children &#39; s personal information. We will
        designate a person to be responsible for the protection of children
        &#39; s personal information. We will also develop an internal special
        system for the protection of children &#39; s personal information.
      </p>
      <p>
        7.4.2 When you, as the guardian, choose to use relevant services of
        Qiniu Cloud for your ward of a child, we may need to collect the
        personal information of the child from you for the purpose of performing
        relevant services to you. If it is necessary to collect personal
        information of children in the specific services, we will obtain prior
        authorization from you and inform you of the purpose and use of the
        collection. If you do not provide the above information, you will not be
        able to enjoy the relevant services provided by us.As the guardian, you
        shall properly perform your guardianship duties and protect the safety
        of children &#39; s personal information. If a child needs to register
        himself / herself or use our products and / or services, you shall
        properly guide and monitor him / her.
      </p>
      <p>
        7.4.3 Children or their guardians have the right to access and correct
        children &#39; s personal information at any time, and can also request
        us to make corrections and deletions.If you have any comments,
        suggestions or complaints, reports on matters related to children &#39;
        s personal information, please contact us.We will always be there to
        help you.
      </p>
      <p>
        7.4.4 If we find ourselves having collected personal data from a child
        without first, verifiable guardian consent, we try to delete the data as
        soon as possible.
      </p>
      ...
      <p>
        ...
        <span className={cls(style.bold, style.underline)}>
          ...
          services provided by such third parties. We do not control the privacy
          and data protection policies of third parties but we will make efforts
          to require them to take protective measures to protect your personal
          information. You have the right to choose whether or not to access the
          links, content, products and services provided by third parties but it
          is advisable to contact such third parties to obtain details about
          their privacy policies before submitting personal information to such
          third parties. If you find that there are risks to the links, content,
          products and services provided by such third parties, it is advisable
          to terminate the relevant operation to protect your legitimate rights
      ...
      <h3>9. Update</h3>
      <p>
        9.1 Because of the changing nature of the Internet, we reserve the right
        to update or revise this Policy from time to time.Such revisions shall
        constitute part of our cost policy; in principle, we will not reduce
      ...
      <p>
        ...
        <span className={cls(style.bold, style.underline)}>
          ...
          posting the latest version of the Privacy Policy on our website or by
          email or otherwise, before such amendment becomes effective, we will
          notify and remind you of any amendment to the Privacy Policy in a
          conspicuous place on our website or by other means, and we will
          provide more prominent notices (including that for certain services,
      ...
      <p>
        10.1 If you have any questions, comments, suggestions or complaints
        regarding Qiniu Cloud and this Policy, you can contact us at:
      </p>
      <p>
        <span>10.1.1 </span>
        <a href="https://support.qiniu.com/tickets/new" target="_blank" rel="noreferrer noopener">
      ...
      <p>
        ...
        Pudong Software Park, 66 Boxia Road, Pudong New Area, Shanghai.
      </p>
      <p>
        10.2 To ensure that we can efficiently deal with your questions and give
        you timely feedback, you are required to submit proof of identity, valid
        contact information, written requests and relevant evidence.We will
        process your request after we verify your identity.
      </p>
      <p>Updated and Effective on November 1, 2021</p>
    </div>
  )
}
