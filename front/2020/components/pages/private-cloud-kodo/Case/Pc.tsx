/**
 * @file 私有云存储客户案例 Pc 端 index.tsx
 * @description 包含私有云存储客户案例 Pc 端
    ...
    >
      ...
      >
        <div className={styles.panel}>
          <div className={styles.title}>人民网</div>
      ...
      <TabPane
        tab={tabIconMap.jiangSuTV}
        value="2"
      >
        <div className={styles.panel}>
          <div className={styles.title}>江苏卫视</div>
          <div className={styles.group}>
            <div className={styles.item}>
              <div className={styles.itemTitle}>客户痛点</div>
      ...
      <TabPane
        tab={tabIconMap.chinaMobile}
        value="3"
      >
        <div className={styles.panel}>
          <div className={styles.title}>中国移动</div>
          <div className={styles.group}>
            <div className={styles.item}>
              <div className={styles.itemTitle}>客户痛点</div>
      ...
      <TabPane
        tab={tabIconMap.yingShi}
        value="4"
      >
        <div className={styles.panel}>
          <div className={styles.title}>海康萤石</div>
          <div className={styles.group}>
            <div className={styles.item}>
              <div className={styles.itemTitle}>客户痛点</div>
            ...
            <div className={styles.item}>
              <div className={styles.itemTitle}>解决方案</div>
              <p>
                1、存储，媒体服务器分离部署，媒体服务器不再转发视频流，视频流直接落存储，
                消除系统瓶颈分布式对象存储支持扩展到 EB 级别，并采用 scale-out 存储架构，可支持更多的摄像头路数
              </p>
            ...
            <div className={styles.item}>
              <div className={styles.itemTitle}>实现价值</div>
              <p>
                1、在消除原有各类痛点的同时，降低原有存储设备成本，同时利用边缘存储与边缘计算技术提高带宽利用率。真
                正实现监控视频去 SD 化，解决了传统监控设备的 SD 或 NVR 空间有限，成本较高，读写寿命短，数据安全，
                无法保障且运维复杂等问题。厂商无需再担心底层关键技术，专心业务层拓展。
              </p>
            </div>
          </div>
        </div>
      ...
      <TabPane
        tab={tabIconMap.pingAn}
        value="5"
      >
        <div className={styles.panel}>
          <div className={styles.title}>中国平安</div>
          <div className={styles.group}>
            <div className={styles.item}>
              <div className={styles.itemTitle}>客户痛点</div>
            ...
            <div className={styles.item}>
              <div className={styles.itemTitle}>实现价值</div>
              <p>
                1、提供支持百亿级业务属性存取的数据管理平台（UDMP），确保了平安银行各业务系统平滑在线迁移，
                实现了行内影像数据的统一存储、处理和管理，解决了业务系统之间数据实时共享和快速访问响应
              </p>
            </div>
          </div>
        </div>
      ...
      <TabPane
        tab={tabIconMap.fengHuang}
        value="6"
      >
        <div className={styles.panel}>
          <div className={styles.title}>凤凰金融</div>
          <div className={styles.group}>
            <div className={styles.item}>
              <div className={styles.itemTitle}>客户痛点</div>
            ...
            <div className={styles.item}>
              <div className={styles.itemTitle}>解决方案</div>
              <p>
                1、实时音视频云：支持多种双录模式（远程双录，自助双录），
                支持多种风险揭示方式（图片、视频、语音、PPT ），后台管理系统，支持检索、回放、审核
              </p>
