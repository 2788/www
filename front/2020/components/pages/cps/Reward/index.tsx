...
const footer = (
  <div className={style.footer}>
    注意：返佣奖励将根据推广等级分期结算给推广者，关于更多规则请查看
    <Link blue href="https://developer.qiniu.com/mkt/manual/7261/cps-promotion-rules"> CPS 推广解释</Link>
  </div>
)
export default function Reward() {
  ...
  return (
    <Section name="reward" title="推广奖励">
      <Table
        bordered
