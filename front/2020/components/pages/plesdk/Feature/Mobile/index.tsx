    ...
    <div className={style.wrapper}>
      <Menu mode="inline" level={-1}>
        <SubMenu mode="inline" title="推流">
          ...
          <MenuItem><Card title="自定义 SEI 消息" desc="主要用于直播答题等场景，用于主播端自定义消息附随推流。" /></MenuItem>
        </SubMenu>
        <SubMenu mode="inline" title="视频">
          ...
          <MenuItem><Card title="自定义图像处理" desc="用户可以通过回调接口，获取当前音视频数据，实现自定义音视频数据处理。" /></MenuItem>
        </SubMenu>
        <SubMenu mode="inline" title="音频">
          ...
          <MenuItem><Card title="耳机返听" desc="当主播带上耳机唱歌时，从耳机中可以实时听到自己的声音，该功能可以帮助主播在唱歌等场景下实时监听自己的声音。一般该功能会跟背景音乐的混音功能一起使用。也蓝牙耳机的返听。" /></MenuItem>
        </SubMenu>
        <SubMenu mode="inline" title="美颜">
          <MenuItem><Card title="美颜" desc="基于字节跳动人脸识别技术，美白、磨皮、锐化、大眼、瘦脸，效果更明显。" /></MenuItem>
        </SubMenu>
        <SubMenu mode="inline" title="滤镜">
          <MenuItem><Card title="滤镜" desc="多款风格滤镜，满足各类场景需要。" /></MenuItem>
        </SubMenu>
        <SubMenu mode="inline" title="贴纸">
          <MenuItem><Card title="贴纸" desc="上千款贴纸任意挑选，2D、3D 人脸贴纸应有尽有。" /></MenuItem>
        </SubMenu>
      </Menu>
    </div>
  )
