...
export default function Case() {
  return (
    <Section title="典型客户案例" name="case">
      ...
      <Row><MyCard imgUrl={case4} title="上海烟草集团" text="七牛云机器数据分析平台 Pandora 强大的数据处理性能可实现不通来源类型的数据字段归一化，零难度实时采集、监控海量传感器数据，高效灵活分析并生成多维度报表，帮助相关工作人员更好的了解设备实时工作状况，并基于设备历史运转数据结合专业模型，预测和及时感知生产故障，快速恢复响应，提升巡检效率，节约人力，保障生产安全。" /></Row>
    </Section>
  )
}
