    ...
    <Section title="企业发展历史" name="timeline">
      <div className={styles.timeline}>
        ...
        <TimeNode year={2019} height={124}>
          <Event title="2019 年 12 月" content="服务企业用户达百万级，覆盖国内 90% 网民" position="right" top={44} />
        </TimeNode>
        ...
        <TimeNode year={2016} height={124}>
          <Event title="2016 年 02 月" content="完成 D 轮融资，投资方包括方广资本、嘉实投资、张江高科、澳洲电信等知名机构" position="right" top={64} />
        </TimeNode>
        <TimeNode year={2014} height={124}>
          <Event title="2014 年 08 月" content="获得 C 轮数千万美元融资，由宽带资本领投，经纬中国和启明创投跟投" position="left" top={44} />
        </TimeNode>
        <TimeNode year={2013} height={124}>
          <Event title="2013 年 01 月" content="获得启明创投、经纬中国千万美元 B 轮投资" position="right" top={44} />
        </TimeNode>
