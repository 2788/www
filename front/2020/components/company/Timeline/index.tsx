  ...
  return (
    <Section title="七牛点点滴滴" name="timeline" header="七牛云点点滴滴">
      <div className={styles.timeline}>
        ...
        <TimeNode year={2014} height={160}>
          <Event title="2014 年 08 月" content="获得 C 轮数千万美元融资，由宽带资本领投，经纬中国和启明创投跟投" position="right" top={40} />
        </TimeNode>
        <TimeNode year={2016} height={160}>
          <Event title="2016 年 02 月" content="完成 D 轮融资，投资方包括方广资本、嘉实投资、张江高科、澳洲电信等知名机构" position="left" top={40} />
        </TimeNode>
        <TimeNode year={2017} height={180}>
          <Event title="2017 年 01 月" content="智能大数据平台上线，结合七牛云生态，为用户赋能应用大数据的核心能力" position="left" top={40} />
          <Event title="2017 年 08 月" content="宣布完成新一轮 10 亿元融资，阿里集团、云锋基金领投" position="right" top={70} />
        </TimeNode>
        <TimeNode year={2019} height={160}>
          <Event title="2019 年 12 月" content="七牛云服务的企业用户已达百万级，覆盖国内 90% 网民。" position="left" top={40} />
        </TimeNode>
        <TimeNode year={2020} height={160}>
          <Event title="2020 年 4 月" content="七牛云完成从 IT 到 DT 的全新战略升级，致力于以数据科技全面驱动数字化未来，赋能各行各业全面进入数据时代。" position="right" top={40} />
        </TimeNode>
      </div>
    </Section>
  )
