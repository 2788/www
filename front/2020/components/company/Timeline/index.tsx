...
function TimeNode({ year, height, children }: PropsWithChildren<TimeNodeProps>) {
  return (
    <div className={styles.node} style={{ height }}>
...
function Event({ title, content, position, top }: EventProps) {
  return (
    <div className={classnames(styles.event, styles[position])} style={{ top: top ? `${top}px` : '0' }}>
    ...
    <Section title="七牛点点滴滴" name="timeline" header="七牛云点点滴滴">
      <div className={styles.timeline}>
        ...
        <TimeNode year={2014} height={220}>
          ...
          <Event title="2014 年 12 月" content="海外加速服务上线，覆盖全球 31 个国家共 54 个地区" position="left" top={140} />
        </TimeNode>
        ...
        <TimeNode year={2016} height={260}>
          ...
          <Event title="2016 年 12 月" content="获得 ISO/IEC 27001:2013 信息安全管理体系认证证书" position="left" top={180} />
          <Event title="2016 年 11 月" content="获国家高新技术企业证书" position="right" top={160} />
        </TimeNode>
        <TimeNode year={2017} height={380}>
          ...
          <Event title="2017 年 08 月" content="宣布完成新一轮 10 亿元融资，阿里集团、云锋基金领投" position="left" top={160} />
          <Event title="2017 年 09 月" content="七牛云人工智能团队勇斩 ACMMM LSVC 竞赛亚军，视频识别能力获国际认可" position="right" top={180} />
          <Event title="2017 年 10 月" content="七牛云获工信部颁发的 CDN 牌照及云服务牌照" position="left" top={280} />
        </TimeNode>
        <TimeNode year={2018} height={260}>
          ...
          <Event title="2018 年 07 月" content="推出一站式 AI 内容安全产品「明瞳 2.0」" position="left" top={140} />
          <Event title="2018 年 09 月" content="与复旦大学合作成立「复旦-七牛深度学习联合实验室" position="right" top={160} />
        </TimeNode>
