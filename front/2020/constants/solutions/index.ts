...
export const descMap = {
  ...
  [Solution.Edu]: '以出色的技术能力全场景覆盖，实现直播教学、课程回看、师生身份核验等功能，打造满足不同群体的在线学习解决方案'
}

export const categorySolutionsMap = {
  [Category.Scene]: [Solution.Qavs, Solution.Plsv, Solution.Kodoe, Solution.Vcs],
  [Category.Industry]: [Solution.Ess, Solution.Edu]
}

export const iconMap: { [key in Solution]: FC<SVGAttributes<SVGElement>> } = {
