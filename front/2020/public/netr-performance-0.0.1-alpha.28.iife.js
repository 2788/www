...
var netrPerformance = function(exports) {
  "use strict";
  ...
  class SchemaLogger {
    constructor(schemaName, fetch, flushNum, flushWait) {
  ...
  const _NetrPerformance = class {
    ...
    static initInstance(type, app) {
      const performance = new _NetrPerformance(type, app);
      performance.pageLoadPerformance();
      performance.resourceLoadPerformance();
      _NetrPerformance.netrPerformanceInstance = performance;
      return performance;
    }
    static create(app) {
      return new Promise((resolve, reject) => {
        if (_NetrPerformance.netrPerformanceInstance === void 0) {
          if ("serviceWorker" in navigator && "caches" in window) {
            navigator.serviceWorker.getRegistrations().then(function(registrations) {
              return __async(this, null, function* () {
                if (registrations.length === 0) {
                  resolve(
                    _NetrPerformance.initInstance("direct", app)
                  );
                } else {
                  try {
            ...
            resolve(_NetrPerformance.initInstance("direct", app));
          }
        } else {
          resolve(_NetrPerformance.netrPerformanceInstance);
        }
      });
    }
    pageLoadPerformance() {
  ...
  let NetrPerformance = _NetrPerformance;
  __publicField(NetrPerformance, "netrPerformanceInstance");
  exports.NetrPerformance = NetrPerformance;
